...
namespace Colossal.Mods
{
    public class Decapitation : MonoBehaviour
    {
        ...
        {
            return GorillaLocomotion.GTPlayer.Instance.leftControllerTransform.position.y < GorillaTagger.Instance.mainCamera.transform.position.y && GorillaLocomotion.GTPlayer.Instance.rightControllerTransform.position.y < GorillaTagger.Instance.mainCamera.transform.position.y;
        }
        private static float CalculateTorsoYRotation()
        {
            ...
            Vector3 handCenter = (GorillaLocomotion.GTPlayer.Instance.leftControllerTransform.position + GorillaLocomotion.GTPlayer.Instance.rightControllerTransform.position) / 2f;
