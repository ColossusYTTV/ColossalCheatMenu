    ...
    public class TagGun : MonoBehaviour
    {
        ...
        public void Update()
        {
            if (PluginConfig.taggun && PhotonNetwork.InRoom)
            {
                ...
                Physics.Raycast(GorillaLocomotion.GTPlayer.Instance.rightControllerTransform.position - GorillaLocomotion.GTPlayer.Instance.rightControllerTransform.up,
                                -GorillaLocomotion.GTPlayer.Instance.rightControllerTransform.up, out raycastHit, float.PositiveInfinity, combinedLayerMask);
