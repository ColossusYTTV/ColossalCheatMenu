...
namespace Colossal.Mods
{
    public class Throw : MonoBehaviour
    {
        ...
        public void Awake()
        {
            right = GorillaLocomotion.GTPlayer.Instance.leftControllerTransform.AddComponent<LocalGorillaVelocityTracker>();
            left = GorillaLocomotion.GTPlayer.Instance.rightControllerTransform.AddComponent<LocalGorillaVelocityTracker>();
        }
        public void Update()
        {
