    ...
    internal class Boards : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            try
            {
                ...
                {
                    cocktext.GetComponent<TextMeshPro>().text = $"Thank you for using CCMV2, the successor to the first cheat menu!\n\nContributors:\nColossusYTTV: Menu Maker/Mod Creator\nLars/LHAX: Menu Base\nStarry: Dev/Tester\nMios: Tester/Manager/Pain In The Ass\nWM/Will: No Fingers/Full Bright/HzHands\nVentern: Anti Screen Share\n\nMenu Version: {OnGameInit.localversion}, Server Version: {OnGameInit.serverversion}\nCCMV2 Users Online: {BepInPatcher.playercount}".ToUpper(); // doing this because the font is so fucked
                    if(cock.GetComponent<TextMeshPro>().text != "COLOSSAL CHEAT MENU V2")
                        cock.GetComponent<TextMeshPro>().text = "COLOSSAL CHEAT MENU V2";
